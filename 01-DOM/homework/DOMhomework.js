...
document.querySelector("#createdBy").innerHTML =
  document.querySelector("#createdBy").innerHTML + " Eddie";

//const author = document.querySelector("#createdBy");
//author.innerHTML = author.innerHTML + " Eddie";
...
function buildToDos(toDos) {
  ...
  // **** LA MISMA FUNCION PERO CON UN CICLO FOR ****
...
function displayToDos() {
  ...
  //**** TAMBIEN SE PUEDE IMPLEMENTAR CON UN forEach, NO CON UN map PORQUE ESTE CREA UN ARRAY NUEVO
  //buildedToDos.forEach(function (element) {
...
// addButton.onclick = addToDO --> otra forma de hacer el addEventListener
